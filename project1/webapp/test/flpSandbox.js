		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Movies",
									"targetURL": "#opensapproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"opensapproject1-display": {
								"semanticObject": "opensapproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=opensap.project1",
									"url": sap.ui.require.toUrl("opensap/project1")
								}
							}
						}
					}
